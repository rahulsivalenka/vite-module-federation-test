...
const moduleMap= {'react':{get:()=>()=>__federation_import('./__federation_shared_react.js'),import:true,requiredVersion:'^18.2.0'},'react-dom':{get:()=>()=>__federation_import('./__federation_shared_react-dom.js'),import:true,requiredVersion:'^18.2.0'}};
